...
struct Forecastday: Codable, Equatable, Hashable {
    static func == (lhs: Forecastday, rhs: Forecastday) -> Bool {
        return lhs.day == rhs.day && lhs.astro == rhs.astro && lhs.hour == rhs.hour
    }
...
// MARK: - Astro
struct Astro: Codable, Equatable, Hashable {
...
// MARK: - Hour
struct Hour: Codable, Equatable, Hashable {
    let timeEpoch: Int?
    let time: String?
